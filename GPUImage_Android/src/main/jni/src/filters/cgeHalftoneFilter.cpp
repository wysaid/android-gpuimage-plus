...
static CGEConstString s_fshHalftone = CGE_SHADER_STRING_PRECISION_M
(
...
namespace CGE
{
	...
	void CGEHalftoneFilter::render2Texture(CGE::CGEImageHandlerInterface* handler, GLuint srcTexture, const GLfloat* posVertices)
	{
		handler->setAsTarget();
		m_program.bind();
