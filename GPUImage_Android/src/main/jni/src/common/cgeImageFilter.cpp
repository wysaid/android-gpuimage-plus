...
namespace CGE
{
	...
	CGEConstString g_fshDefault = CGE_SHADER_STRING_PRECISION_M
	(
	varying vec2 textureCoordinate;
	...
	CGEImageFilterInterface::CGEImageFilterInterface() : m_uniformParam(NULL)
	{
...
// 	}
	...
	void CGEImageFilterInterface::render2Texture(CGEImageHandlerInterface* handler, GLuint srcTexture, const GLfloat* posVertices)
	{
		handler->setAsTarget();
		m_program.bind();
