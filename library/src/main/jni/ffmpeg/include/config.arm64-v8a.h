...
#define FFMPEG_CONFIGURATION "--target-os=linux --prefix=/opt/ffmpeg/arm64-v8a --tempprefix=/opt/ffmpeg/arm64-v8a-build/tmp --enable-small --enable-cross-compile --arch=aarch64 --cc=/opt/ffmpeg/build_script/ndk-build-toolchain/arm64/bin/aarch64-linux-android-clang --cross-prefix=/opt/ffmpeg/build_script/ndk-build-toolchain/arm64/bin/aarch64-linux-android- --nm=/opt/ffmpeg/build_script/ndk-build-toolchain/arm64/bin/llvm-nm --ar=/opt/ffmpeg/build_script/ndk-build-toolchain/arm64/bin/llvm-ar --ranlib=/opt/ffmpeg/build_script/ndk-build-toolchain/arm64/bin/llvm-ranlib --strip=/opt/ffmpeg/build_script/ndk-build-toolchain/arm64/bin/llvm-strip --extra-cflags=-I/opt/ffmpeg/build/x264/arm64-v8a/include --extra-ldflags=-L/opt/ffmpeg/build/x264/arm64-v8a/lib --sysroot=/opt/ffmpeg/build_script/ndk-build-toolchain/arm64/sysroot --extra-cflags='-DANDROID -O3 -fPIC -ffunction-sections -funwind-tables -fstack-protector -fomit-frame-pointer -fstrict-aliasing -Wno-incompatible-function-pointer-types' --extra-ldflags='-Wl,-rpath-link=/opt/ffmpeg/build_script/ndk-build-toolchain/arm64/sysroot/usr/lib -L/opt/ffmpeg/build_script/ndk-build-toolchain/arm64/sysroot/usr/lib -lc -lm -ldl -llog -fPIC' --enable-zlib --enable-static --disable-shared --disable-symver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-avdevice --disable-bsfs --disable-devices --disable-protocols --enable-zlib --enable-protocol=file --enable-protocol=pipe --enable-protocol=concat --disable-parsers --enable-parser=h264 --enable-parser=aac --disable-demuxers --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=aac --enable-demuxer=mpegts --enable-demuxer=image2 --disable-decoders --enable-decoder=aac --enable-decoder=h264 --enable-decoder=mp3 --enable-decoder=png --enable-decoder=mjpeg --disable-muxers --enable-muxer=mp4 --enable-muxer=mov --enable-muxer=mp3 --enable-muxer=mpegts --enable-muxer=image2 --disable-encoders --enable-encoder=aac --enable-encoder=libx264 --enable-encoder=png --enable-encoder=mjpeg --enable-gpl --disable-network --enable-hwaccels --disable-avfilter --enable-asm --enable-version3 --enable-gpl --enable-libx264 --disable-doc --enable-neon --disable-filters --enable-pic --enable-yasm --pkg-config-flags=--static"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "/opt/ffmpeg/arm64-v8a/share/ffmpeg"
#define AVCONV_DATADIR "/opt/ffmpeg/arm64-v8a/share/ffmpeg"
