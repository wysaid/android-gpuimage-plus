...
#define FFMPEG_CONFIGURATION "--target-os=linux --prefix=/opt/ffmpeg/armeabi-v7a --tempprefix=/opt/ffmpeg/armeabi-v7a-build/tmp --enable-small --enable-cross-compile --arch=arm --cc=/opt/ffmpeg/build_script/ndk-build-toolchain/arm/bin/arm-linux-androideabi-clang --cross-prefix=/opt/ffmpeg/build_script/ndk-build-toolchain/arm/bin/arm-linux-androideabi- --nm=/opt/ffmpeg/build_script/ndk-build-toolchain/arm/bin/llvm-nm --ar=/opt/ffmpeg/build_script/ndk-build-toolchain/arm/bin/llvm-ar --ranlib=/opt/ffmpeg/build_script/ndk-build-toolchain/arm/bin/llvm-ranlib --strip=/opt/ffmpeg/build_script/ndk-build-toolchain/arm/bin/llvm-strip --extra-cflags=-I/opt/ffmpeg/build/x264/armeabi-v7a/include --extra-ldflags=-L/opt/ffmpeg/build/x264/armeabi-v7a/lib --sysroot=/opt/ffmpeg/build_script/ndk-build-toolchain/arm/sysroot --extra-cflags='-DANDROID -O3 -fPIC -ffunction-sections -funwind-tables -fstack-protector -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fomit-frame-pointer -fstrict-aliasing -Wno-incompatible-function-pointer-types' --extra-ldflags='-Wl,-rpath-link=/opt/ffmpeg/build_script/ndk-build-toolchain/arm/sysroot/usr/lib -L/opt/ffmpeg/build_script/ndk-build-toolchain/arm/sysroot/usr/lib -lc -lm -ldl -llog -fPIC' --enable-zlib --enable-static --disable-shared --disable-symver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-avdevice --disable-bsfs --disable-devices --disable-protocols --enable-zlib --enable-protocol=file --enable-protocol=pipe --enable-protocol=concat --disable-parsers --enable-parser=h264 --enable-parser=aac --disable-demuxers --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=aac --enable-demuxer=mpegts --enable-demuxer=image2 --disable-decoders --enable-decoder=aac --enable-decoder=h264 --enable-decoder=mp3 --enable-decoder=png --enable-decoder=mjpeg --disable-muxers --enable-muxer=mp4 --enable-muxer=mov --enable-muxer=mp3 --enable-muxer=mpegts --enable-muxer=image2 --disable-encoders --enable-encoder=aac --enable-encoder=libx264 --enable-encoder=png --enable-encoder=mjpeg --enable-gpl --disable-network --enable-hwaccels --disable-avfilter --enable-asm --enable-version3 --enable-gpl --enable-libx264 --disable-doc --disable-neon --disable-filters --enable-pic --enable-yasm --disable-armv5te --pkg-config-flags=--static"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define CONFIG_THIS_YEAR 2020
#define FFMPEG_DATADIR "/opt/ffmpeg/armeabi-v7a/share/ffmpeg"
#define AVCONV_DATADIR "/opt/ffmpeg/armeabi-v7a/share/ffmpeg"
