...
JNIEXPORT jlong JNICALL Java_org_wysaid_nativePort_CGEMultiInputFilterWrapper_nativeCreate
        (JNIEnv *env, jclass cls, jstring vsh, jstring fsh)
{
...
JNIEXPORT void JNICALL Java_org_wysaid_nativePort_CGEMultiInputFilterWrapper_nativeRelease
        (JNIEnv *env, jclass cls, jlong addr)
{
    delete (CGE::CGEMultiInputFilter*)addr;
}

JNIEXPORT void JNICALL Java_org_wysaid_nativePort_CGEMultiInputFilterWrapper_nativeUpdateInputTextures
        (JNIEnv *env, jobject cls, jlong addr, jobject textures, int count)
{
