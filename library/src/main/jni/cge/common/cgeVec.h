...
public:
    ...
    inline Type& x()
    {
        cgeStaticAssert(DIM >= 1);
        return m_data[0];
    }
    inline Type& y()
    {
        cgeStaticAssert(DIM >= 2);
        return m_data[1];
    }
    inline Type& z()
    {
        cgeStaticAssert(DIM >= 3);
        return m_data[2];
    }
    inline Type& w()
    {
        cgeStaticAssert(DIM >= 4);
        return m_data[3];
    }
    inline Type& r()
    {
    ...
    inline const Type& r() const
    {
        cgeStaticAssert(DIM >= 1);
        return m_data[0];
    }
    inline const Type& g() const
    {
        cgeStaticAssert(DIM >= 2);
        return m_data[1];
    }
    inline const Type& b() const
    {
        cgeStaticAssert(DIM >= 3);
        return m_data[2];
    }
    inline const Type& a() const
    {
        cgeStaticAssert(DIM >= 4);
        return m_data[3];
    }
    ...
    {
        cgeStaticAssert(DIM == 2);
        return CGPointMake(m_data[0], m_data[1]);
    }
    inline operator CGSize() const
    {
        cgeStaticAssert(DIM == 2);
        return CGSizeMake(m_data[0], m_data[1]);
    }
    inline Vec& operator=(const CGPoint& p)
    {
        cgeStaticAssert(DIM == 2);
        m_data[0] = p.x;
        m_data[1] = p.y;
